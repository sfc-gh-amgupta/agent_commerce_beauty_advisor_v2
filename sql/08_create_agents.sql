...
CREATE OR REPLACE AGENT AGENT_COMMERCE.UTIL.AGENTIC_COMMERCE_ASSISTANT
FROM SPECIFICATION $$
{
  "instructions": {
...
CREATE OR REPLACE AGENT AGENT_COMMERCE.UTIL.EXECUTIVE_PRODUCT_360
FROM SPECIFICATION $$
{
  "instructions": {
...
CREATE OR REPLACE MCP SERVER AGENT_COMMERCE.UTIL.AGENTIC_COMMERCE_MCP_SERVER
  FROM SPECIFICATION $$
    tools:
